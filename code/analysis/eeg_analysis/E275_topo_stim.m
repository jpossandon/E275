...
for e = 1:length(difflabels)
    ...
    fh                  = plot_topos(cfg_eeg,diffdata(e),p.interval,p.bsl,p.colorlim,[cfg_eeg.sujid ' imlock ' difflabels{e} ' / ' p.analysis_type{1} ' / bsl: ' sprintf('%2.2f to %2.2f /',p.bsl(1),p.bsl(2))]);
